...
async function GET(request) {
    try {
        ...
        let invoices;
        if (type && status) {
            invoices = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        SELECT i.*,
      ...
      `;
        ...
        if (search) {
            ...
            filtered = invoices.filter((inv)=>inv.invoice_number?.toLowerCase().includes(q) || inv.client_name?.toLowerCase().includes(q) || inv.supplier_name?.toLowerCase().includes(q));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: filtered
...
async function POST(request) {
    try {
        ...
        const { type, clientId, supplierId, orderId, items, notes, amountPaid } = body;
        if (!type || ![
            'client',
            'supplier'
        ].includes(type)) {
        ...
        if (items && items.length > 0) {
            totalAmount = items.reduce((acc, item)=>acc + Number(item.quantity) * Number(item.unitPrice), 0);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34f8363e._.js.map