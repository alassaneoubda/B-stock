...
"[project]/app/api/returns/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const returns = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      SELECT r.*,
      ...
      WHERE r.company_id = ${companyId}
        ${returnType ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`AND r.return_type = ${returnType}` : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]``}
...
async function POST(request) {
    try {
        ...
        if (!return_type || !items || items.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Type de retour et articles requis'
            }, {
                status: 400
            });
        }
        // Generate return number
        const countResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT COUNT(*) as count FROM returns WHERE company_id = ${companyId}`;
    ...
    `;
      ...
      VALUES (${companyId}, ${userId}, 'create', 'return', ${result[0].id}, ${JSON.stringify({
            return_type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86413af0._.js.map