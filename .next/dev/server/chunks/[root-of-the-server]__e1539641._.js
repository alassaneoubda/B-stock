...
async function GET() {
    try {
        ...
        const schemaPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'scripts', '001-create-tables.sql');
    ...
    `;
        for (const statement of dropTablesSql.split(';').map((s)=>s.trim()).filter((s)=>s.length > 0)){
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])(statement);
        }
        // 2. Execute the schema
        // Remove comments and split by semicolon
        const sqlContent = schemaSql.replace(/--.*$/gm, '') // Remove single line comments
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id FROM users WHERE email = ${email}`;
        if (existing.length === 0) {
            const passwordHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$2$2e$4$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hash"])(password, 12);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1539641._.js.map