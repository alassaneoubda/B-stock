    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-72 max-w-[85vw] p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-64 shrink-0 bg-transparent transition-[width] duration-200 ease-linear',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-30 hidden h-svh w-64 transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
